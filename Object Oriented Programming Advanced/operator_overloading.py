# In Python, there exists also the possibility of operator overloading when dealing with comparison of objects

"""
we have the following functions corresponding to operators:
1. == -> __eq__(self,other)
2. > -> __gt__(self,other)
3. < -> __lt__(self.other)
4. >= -> __ge__(self, other)
5. <= 0> __le__(self,other)
6. != -> __ne__(self,other
"""
...
is_found = any([message == new_message for message in messages_list])
