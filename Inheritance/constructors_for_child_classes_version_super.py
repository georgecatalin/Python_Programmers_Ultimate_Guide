...
class Developer(Employee):
    ...
    def __init__(self, full_name, job, skill):
        ...
        """
        self.skill = skill
        super().__init__( full_name, job)
        # explicitly call the constructor of the Base Class in the constructor of the Child Class
        # when using the super() function, there is no need to include 'self' as an argument of the __init__() constructor method
